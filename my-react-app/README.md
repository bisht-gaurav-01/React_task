...
- Products are requested from Redux directly into the main product table, keeping the UI aligned with the task requirement to source data from the store.
...
- All CRUD actions now live directly inside the main product table so read, add, edit, and delete happen in one place.
